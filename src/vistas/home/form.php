                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="row">
                      <div class="col-lg-4 col-xs-12">
                        <div class="form-group">
                          <label>RUC: 80113725-0</label>

                        </div>
                      </div>
                      <div class="col-lg-4 col-xs-12">
                        <div class="form-group">
                          <label>Email: centralfoods.801@gmail.com</label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-xs-12">
                        <div class="form-group">
                          <label><i class="fa fa-file"></i>  Constitucion de Sociedad</label>
                          <label><i class="fa fa-file"></i>  Constitucion de Sociedad</label>
